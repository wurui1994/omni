...
class AsyLower {
  ...
  nameOf(n, nm) {
    ...
    const cands = asyVisible(this, nm);
    if (cands.length === 1) {
      const c = cands[0];
      if (c.ps !== undefined) {
  ...
  exprList(n, h) {
    ...
    if (h === 'call') return asyCall(this, n);
    ...
    if (h === 'join-exp') return asyJoinExp(this, n);
  ...
  pairCall(n, nm) {
    const args = asyArgs(this, n.items[2]);
  ...
  binary(n) {
    ...
    const u = asyOpUser(this, n, op, [a, b], asyOpBuiltinSig(this, [a, b]));
    if (u !== null) return u;
  ...
  unary(n) {
    ...
    const u = asyOpUser(this, n, op, [v], asyOpBuiltinSig(this, [v]));
    if (u !== null) return u;
    if (op === '!') {
  ...
  assign(node, lhs, rhs, op) {
    ...
    const uv = asyOpUser(this, node, op, [cv, one], asyOpBuiltinSig(this, [cv, one]));
    if (uv !== null) {
  ...
  assignFld(node, q, rhs, op) {
    ...
    const uf = asyOpUser(this, node, op, [cf, one], asyOpBuiltinSig(this, [cf, one]));
    if (uf !== null) {
  ...
  assignIndex(node, lhs, rhs, op) {
    ...
    const ue = asyOpUser(this, node, op, [ce, one], asyOpBuiltinSig(this, [ce, one]));
    if (ue !== null) {
