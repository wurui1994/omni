// src/core/target/spirv.js —— SPIR-V 后端的插件外壳（ADR-0021 的 S4）
//
...
export function registerSpirvTarget(api) {
  api.registerTarget('spirv', 'mir', (m, o) => emitSpirv(m, o === undefined ? undefined : o.kernel));
}
