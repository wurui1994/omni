...
//     同名却不同规矩）· `graph/backend-wat.js` 6 格（`WAT_ARITH` / `WAT_CMP` / `WAT_FCMP` ·
...
//     改语义，理由记在那格声明旁边）· 1 格（`x64/encode.js` 的 `ret` -> `retInstr`：
//     发 0xc3 的那格与 `lang/common/sx.js` 造 return 语句的那格撞，而那边十二份文件在用、
//     这边只有 `x64/from_mir.js` 与两份测试）。
