...
import {
  ...
  HOIST, LITNONE, MATCH, METHOD2, OPTRES, POINTER, POSINIT, PUSH, INHERIT, OPOVER, TMPL, CTOR, VIRT, CTMPL, LAMBDA, FMT, FORMAT, POSTEST, CTOR2, METHOV, PUREVIRT, DTORCHAIN, MIXVIRT, OUTLINE, CTMPL2,
} from '../lib/cases.js';
...
const MIGRATED = {
  ...
  /* cpp：二十四个家族。`defer` 在这门语言里是 `~Say()`（RAII，与 freebasic 同一手，
