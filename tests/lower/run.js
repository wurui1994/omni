...
import {
  ...
  HOIST, LITNONE, MATCH, METHOD2, OPTRES, POINTER, POSINIT, PUSH, INHERIT, OPOVER, TMPL,
} from '../lib/cases.js';
...
const FAMILIES = {
  ...
  inherit: INHERIT, opover: OPOVER, tmpl: TMPL,
};
const MIGRATED = {
  ...
  cpp: ['basics', 'conv', 'defer', 'dict', 'index', 'inherit', 'intmath', 'loopexit',
    'opover', 'record', 'tmpl', 'values'],
