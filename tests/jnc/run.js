...
//      `unsafe` 之外的 thin 转换、64 位的无符号整数，加两条 jancy 自己也拒的
//      （命名项之后不能再写位置项、`double` 上的 `&=`）。（`? :`、不换行的 printf、条件真值化曾经在
...
//      位运算与移位的复合赋值是第三十五刀，在 cases/24-new-curly.jnc、
