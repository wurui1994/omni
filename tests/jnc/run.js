...
//      数组之间的赋值、`threadlocal`、对 string 的模块级变量取地址、`%g`、
...
//      三个标志是第二十九刀、`%e` / `%E` 是第三十刀，在 cases/24-new-curly.jnc、
//      cases/25-static-local.jnc、cases/26-printf-prec.jnc、cases/27-printf-star-prec.jnc、
//      cases/28-printf-flags.jnc、cases/29-printf-sci.jnc。）
//
//      bad/ 里有**两种**拒，别混：一种是"还没长出来"（printf-conv-g：`%g` 要方言里一条
